...
A public demonstration of a production-grade Playwright E2E architecture**: page objects, chained fixtures, centralized locators, tag-based test selection, a one-time auth setup project, and a CI pipeline that only runs the tests affected by a change.
